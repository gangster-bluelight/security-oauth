...
public class JwtApplicationTests {
    ...
    public void testCreatToken() {
        ...
        JwtBuilder jwtBuilder = Jwts.builder()
                //声明的标识{"jti":"888"}
                .setId("1999")
                //主体，用户{"sub":"blue-light"}
                .setSubject("blue-light")
                //创建日期{"ita":"yjxxtxx"}
                .setIssuedAt(new Date())
                //签名手段，参数1：算法，参数2：盐
                .signWith(SignatureAlgorithm.HS256,"gangster");
        //获取jwt的token
    ...
    public void testParseToken(){
        //token
        String token = "eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiIxOTk5Iiwic3ViIjoiYmx1ZS1saWdodCIsImlhdCI6MTY0NDkwNzI3MH0.X8oBSHnZ6nyQ2jbuegoiDalSlooHr5eihHQH5QOP0JA";
        //解析token获取负载中的声明对象
        Claims claims = Jwts.parser()
                .setSigningKey("gangster")
